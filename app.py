...
selected = option_menu ("Kalkulator OP-AMP",
    ["Home",
    "Rangkaian Penjumlahan dengan Op-Amp",],
    default_index=0)

if(selected == "Home") :
    st.header("Kalkulator Perhitungan Rangkaian Penjumlahan dengan Op-Amp")
    st.subheader("By Gefira Aryandra (11-2021-026)")
